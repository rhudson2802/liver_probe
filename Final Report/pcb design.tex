...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\linewidth]{old remote pcb.jpg}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.8\linewidth]{remote pcb.jpg}
