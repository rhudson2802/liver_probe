...
\begin{table}[htb]
	\centering
	\caption{Results for feedback resistor calibration experiments. The peak-to-peak signal is the output difference when the LED was on/off, and the minimum signal is the output voltage when the LED was on.}
